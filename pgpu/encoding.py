...
__all__ = ['fetcher', 'Triplets', 'PD2', 'PD3', 'PD4', 'PD5', 'PD6', 'PD7', 
           'PD8', 'PD9', 'PD10', 'PD11', 'PD12', 'PD13', 'PD14', 'RD', 'SHA1', 
           'SHA224', 'SHA256', 'SHA384', 'SHA512', 'MD5', 'Base16', 'Base32', 
           'Base64', 'Hex', 'HQX', 'UU', 'URL', 'HTML', 'CRC32', 'Adler32']
...
class PD2(object):
    """
    A basic hasher based on the removed PD1(), but with several improvements.
...
class PD3(object):
    """
    A more advanced hasher based on PD2(). NOTE: This is slow!
...
class PD4(object):
    """
    A more advanced hasher based on PD3(). NOTE: This is VERY slow!
...
class PD5(object):
    """
    A hasher that is much faster than PD4(), but not very secure.
...
class PD6(object):
    """
    A hasher that is slower than PD5(), WARNING: It is not recommended that 
    this hasher be used on strings more than 256 characters long.
